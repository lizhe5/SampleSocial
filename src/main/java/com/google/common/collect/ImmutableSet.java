 ...
 *
 * <p>Unlike {@link java.util.Collections#unmodifiableSet}, which is a <i>view</i> of a
 ...
 * java.util.HashSet} for objects with very fast {@link Object#hashCode} implementations
 * (as a well-behaved immutable object should). While this class's factory
 * methods create hash-based instances, the {@link com.google.common.collect.ImmutableSortedSet} subclass
...
public abstract class ImmutableSet<E> extends ImmutableCollection<E>
   ...
   * to {@link java.util.Collections#emptySet}, and is preferable mainly for consistency
   ...
   * performs comparably to {@link java.util.Collections#singleton}, but will not accept
